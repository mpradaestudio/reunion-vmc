...
-- nombre_libre en asignaciones_partes: guarda Conductor/Lector como texto
-- libre durante visita de circuito.
...
ALTER TABLE `asignaciones_partes`
    ADD COLUMN `nombre_libre` VARCHAR(150) NULL DEFAULT NULL
        COMMENT 'Nombre libre (Conductor/Lector durante visita de circuito)';
